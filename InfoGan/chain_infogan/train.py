...
if __name__ == '__main__':
    ...
    for epoch in range(max_epochs):
        ...
        for i in range(0, train_size, batch_size):
            ...
            print("zs shape is %s"%(str(zs.shape)))
            ...
            print("c_categorical shape is %s"%(str(c_categorical.shape)))
            ...
            print("c_continuous shape is %s" % (str(c_continuous.shape)))
            zc = xp.concatenate((zs, c_categorical, c_continuous), axis=1)
            print("all noise shape is %s" % (str(zc.shape)))
            ...
            # Categorical loss
            categorical_loss = F.softmax_cross_entropy(mi_categorical, categories)
